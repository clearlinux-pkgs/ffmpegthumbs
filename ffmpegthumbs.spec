...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/ffmpegthumbs-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/ffmpegthumbs-24.12.3.tar.xz.sig
...
%setup -q -n ffmpegthumbs-24.12.3
cd %{_builddir}/ffmpegthumbs-24.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742443012
mkdir -p clr-build
pushd clr-build
