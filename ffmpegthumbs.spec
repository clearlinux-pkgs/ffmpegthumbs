...
Version  : 24.05.2
Release  : 27
URL      : https://download.kde.org/stable/release-service/24.05.2/src/ffmpegthumbs-24.05.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/ffmpegthumbs-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/ffmpegthumbs-24.05.2.tar.xz.sig
...
%setup -q -n ffmpegthumbs-24.05.2
cd %{_builddir}/ffmpegthumbs-24.05.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720570818
mkdir -p clr-build
pushd clr-build
