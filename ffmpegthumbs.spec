...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/ffmpegthumbs-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/ffmpegthumbs-25.04.1.tar.xz.sig
...
%setup -q -n ffmpegthumbs-25.04.1
cd %{_builddir}/ffmpegthumbs-25.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747095871
mkdir -p clr-build
pushd clr-build
