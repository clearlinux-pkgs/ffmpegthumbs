...
Version  : 24.08.1
Release  : 31
URL      : https://download.kde.org/stable/release-service/24.08.1/src/ffmpegthumbs-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/ffmpegthumbs-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/ffmpegthumbs-24.08.1.tar.xz.sig
...
%setup -q -n ffmpegthumbs-24.08.1
cd %{_builddir}/ffmpegthumbs-24.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726168385
mkdir -p clr-build
pushd clr-build
